...
#Read train data
subjectTrain <- read.table("D:/UCI HAR Dataset/train/subject_train.txt", header = FALSE)
activityTrain <- read.table("D:/UCI HAR Dataset/train/y_train.txt", header = FALSE)
featuresTrain <- read.table("D:/UCI HAR Dataset/train/X_train.txt", header = FALSE)

#Read test data
subjectTest <- read.table("D:/UCI HAR Dataset/test/subject_test.txt", header = FALSE)
activityTest <- read.table("D:/UCI HAR Dataset/test/y_test.txt", header = FALSE)
featuresTest <- read.table("D:/UCI HAR Dataset/test/X_test.txt", header = FALSE)
